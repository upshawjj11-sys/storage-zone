...
import { Plus, FileText, Pencil, Trash2, Eye, Globe } from "lucide-react";
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage About, FAQ, Terms, and custom pages.</p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    if (confirm("Delete this page?")) deleteMutation.mutate(p.id);
                  }}
                >
